...
namespace CSharpCourse
{
    class Program
    {
        ...
        static void IntroToArrays()
        {
            ...
            // Объявление массива сразу выбирая количество элементов в нем
            int[] a2 = new int[5];

            //Объявление массива с его элементами
            int[] a3 = new int[5] { 1, 5, 2, 3, 8 };

            // Объявление массива с его элементами другим способом
            int[] a4 = { 1, 3, 2, 4, 5 };

            // Вывод 4-го элемента массива
            Console.WriteLine(a4[3]);

            //Вывод длины массива
            Console.WriteLine(a4.Length);
            //Вывод последнего элемента массива не зная его длины
            Console.WriteLine(a4[a4.Length - 1]);

            string s1 = "ad,gplrflas";
            //Присваивание переменной значение первого элемента строчки
            char first = s1[0];
            //Присваивание переменной значение последнего элемента строчки, не зная его длины
